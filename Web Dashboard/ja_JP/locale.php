...
"dashboard-announcements-2-success" => "脱退バナーの更新に成功しました。",
"dashboard-update" => "更新",
"dashboard-save" => "保存",
...
"dashboard-modules-title-12" => "(F) Text-Voice Link",
...
"audit-leave" => "脱退メッセージを更新しました。",
"audit-ban" => "Banメッセージを更新しました。",
"audit-channel-announcement" => "Updated announcement channel: :data",
"audit-banner-leave-1" => "脱退バナーをクリアしました。",
"audit-banner-leave-2" => "脱退バナーを更新しました。",
